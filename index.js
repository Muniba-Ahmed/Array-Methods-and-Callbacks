...
//1 param of data
//filter to find all teams that made it to the final stage
...
console.log("Task 2", getFinals(fifaData)); //this is the callback function
...
3. Determines the winner (home or away) of each `finals` game. win conditions?
